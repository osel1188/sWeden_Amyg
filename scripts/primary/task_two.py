...
def run_task_two(
    ...
    *,
    ...
    output_path = output_dir / (name_baseline + "_task_two_output.csv")
    ...
    logging.info(f"[task_two] Processing {input_path.name}")
    raise NotImplementedError("task_two logic not yet implemented")
